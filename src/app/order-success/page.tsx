...
function OrderSuccessContent() {
  ...
  return (
    <div className="bg-white rounded-2xl p-8 md:p-12 shadow-sm border border-gray-100 text-center max-w-lg mx-auto animate-scale-in">
      {/* Success Icon */}
      <div className="w-20 h-20 rounded-full bg-brand-100 flex items-center justify-center mx-auto mb-6">
        <svg className="w-10 h-10 text-brand-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <circle cx="12" cy="12" r="10" />
          <path d="m9 12 2 2 4-4" />
        </svg>
      </div>

      <h1 className="font-heading text-3xl font-bold text-surface-dark mb-3">
        Order Confirmed!
      </h1>
...
export default function OrderSuccessPage() {
  return (
    <>
      <Navbar />
      <main className="min-h-screen bg-surface-alt pt-32 pb-16 flex items-start justify-center">
